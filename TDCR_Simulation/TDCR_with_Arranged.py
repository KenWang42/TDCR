...
Device_result.to_csv(f'result/TDCR_with_Arranged_Device_Result_{nMTCD}.csv', index=False)

D2D_result.to_csv(f'result/TDCR_with_Arranged_D2D_Result_{nMTCD}.csv', index=False)

RA_result.to_csv(f'result/TDCR_with_Arranged_RA_Result_{nMTCD}.csv', index=False)
